...
DEFAULT_DATASET_DIR = '/home/qisens/tensorflow/models/research/attention_ocr/UK/datasets/data/number_plates'
...
DEFAULT_CONFIG = {
    ...
    'splits': {
        'train': {
            'size': 39, # change according to your own train-test split
