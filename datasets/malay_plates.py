...
DEFAULT_DATASET_DIR = '/home/qisens/tensorflow/models/research/attention_ocr/malay/datasets/data/malay_plates'
...
DEFAULT_CONFIG = {
    ...
    'splits': {
        'train': {
            'size': 997, # change according to your own train-test split
            'pattern': 'train.tfrecord'
        },
        'test': {
            'size': 1, # change according to your own train-test split
